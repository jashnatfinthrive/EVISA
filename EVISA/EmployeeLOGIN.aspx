<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EmployeeLOGIN.aspx.cs" Inherits="EVISA.EMPLOGIN" %>
...
<body style="height: 667px;background-color:white">
    <form id="form1" runat="server">
        <p id="nav">
            ...
            <asp:LinkButton ID="LinkButton1" runat="server" Font-Bold="True" Font-Size="XX-Large" Font-Underline="False" ForeColor="#003366" PostBackUrl="~/HOME.aspx" BorderStyle="Dotted">E-VISA</asp:LinkButton>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:LinkButton ID="LinkButton4" runat="server" Font-Bold="True" Font-Size="Large" Font-Underline="False" ForeColor="#003366" PostBackUrl="~/EmployeeLOGIN.aspx" OnClick="LinkButton4_Click">EMPLOYEE</asp:LinkButton>
        ...
        <p>
         ...
         <p style="margin-left:auto;margin-right:auto;text-align:center">
             ...
             &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
             <asp:Label ID="Label4" runat="server" Font-Bold="True" Font-Size="XX-Large" Text="Employee Login" ForeColor="Red"></asp:Label>
        ...
        <div style="border:1px solid black; height: 359px; width:700px;margin-left:auto;margin-right:auto;text-align:center;background-color:cornsilk">
            ...
            <br />
            <br />
            <asp:Label ID="Label5" runat="server" Font-Bold="False" Font-Names="Calibri" Font-Size="X-Large" Text="USER-NAME: "></asp:Label>
...
&nbsp;<asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="*username is mandatory*" ForeColor="Red" ControlToValidate="TextBox1" Display="Dynamic"></asp:RequiredFieldValidator>
            ...
            <br />
            <br />
            <asp:Label ID="Label6" runat="server" Font-Bold="False" Font-Names="Calibri" Font-Size="X-Large" Text="PASSWORD: " BorderColor="Black" BorderStyle="None"></asp:Label>
            ...
            <br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:Button ID="Button1" runat="server" BackColor="#33CCCC" BorderColor="Black" Font-Size="Large" Height="39px" Text="LOGIN" Width="144px" OnClick="Button1_Click" />
            <br />
            <br />
            <asp:Label ID="Label7" runat="server" ForeColor="Red" Text="*Incorrect user-name or password. RE-ENTER" Visible="False"></asp:Label>
